...
// --- AI FALLBACK ENGINE (Bulletproof String Concatenation) ---
async function generateWithFallback(prompt) {
    ...
    try {
        ...
        // Clean key and use standard '+' for URL to prevent formatting errors
        ...
        try {
            ...
            try {
                ...
                const openaiUrl = "[https://api.openai.com/v1/chat/completions](https://api.openai.com/v1/chat/completions)";
